        ...
        <nav class="white container-fluid">
                <div class="nav-wrapper">
                        ...
                        <ul id="nav-mobile" class="right show-on-med-and-down">
                                ...
                                <li>
                                        <a href="{{ route('config')}}" class="black-text tooltipped" data-position="left" data-tooltip="Configuración" style="{{ (auth()->user()->tickets->name_ticket) == 'SUPER USUARIO' ? '' : 'pointer-events: none; cursor: default;' }}">
