...
<head>
    ...
    <title>Sistema para Colas</title>
...
<body class="grey lighten-3">
    ...
    <main>
        <div class="row marginCol">
            <div class="col s8 m7 marginCol">
                <div class="row marginCol">
                    <div class="col s12 m12 " style="padding:0;height: 70%" ;>
                ...
                <div class="row">
                    <div class="col s12 m12 red">
                        <marquee behavior="" direction=""><b id="notice" style="color: #fff; font-size: 40px">UGEL HUANUCO - A SU SERVICIO</b></marquee>
                    </div>
                </div>
            ...
            <div class="col s4 m5 marginCol">

                <div class="row marginCol">
                    <div class="col s12 m12 l12 green accent-4 center-align marginCol">
                        <h6 class="flow-text" style="font-weight:bold;">Llamados</h6>
                    </div>
                </div>

                <div class="row">
                    <div class="col s6 m6 center-align marginCol" style="background-color:#7CD353">
                        <h6 class="flow-text">Turno</h6>
                    </div>
                    <div class="col s6 m6 center-align marginCol" style="background-color:#7CD353">
                        <h6 class="flow-text">Oficina</h6>
                    </div>
                </div>
                ...
                <div class="row marginCol">
                    <div class="col s12 m12 yellow darken-2 center-align marginCol">
                        <h6 class="flow-text" style="font-weight:bold;">En Atención</h6>
                    </div>
                </div>

                <div class="row">
                    <div class="col s6 m6 center-align marginCol" style="background-color:#FFE333">
                        <h6 class="flow-text">Turno</h6>
                    </div>
                    <div class="col s6 m6 center-align marginCol" style="background-color:#FFE333">
                        <h6 class="flow-text">Oficina</h6>
                ...
                <div class="row">
                    <div class="col s12 m12 red center-align marginCol">
                        <h6 class="flow-text" style="font-weight:bold;">En Espera</h6>
                    </div>
                </div>

                <div class="row">
                    <div class="col s6 m6 center-align marginCol" style="background-color:#F96F68">
                        <h6 class="flow-text">Turno</h6>
                    </div>
                    <div class="col s6 m6 center-align marginCol" style="background-color:#F96F68">
                        <h6 class="flow-text" >Oficina</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col s4 m4 center-align" style="margin-top:30px">
                            <div style="margin-left: 30px;">
                                <img style="width:300px; height:120px" src="{{asset('img/sysQ-logo.png')}}" alt="">
                            </div>

                            <div class="container">
                                <p style="font-size: 20px;"> © 2022 UGEL HUANUCO</p>
                            </div>
                        </div>
    ...
    <div class="fixed-action-btn" style="z-index: 99999">
        ...
        <ul>
            <li><a href="#video" class="btn-floating white tooltipped modal-trigger" style="background-color:#34e064" data-position="left" data-tooltip="Seleccionar Video">
                    <i class="icon-vertical_align_top large black-text"></i></a>
            </li>
            <li><button type="button" value="#video" class="btn-floating tooltipped" style="background-color:#1860ab" data-position="left" data-tooltip="Editar Noticias">
        ...
        <div class="modal-content">
            <div class="row">
                <div class="centered col s12 m12">
                    <h5 style="margin-left:15px;"> Videos </h5>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content center-align" style="color:#1860ab;padding: 0;">
            ...
            <div class="card z-depth-2" style="margin: 0;">
                    ...
                    <div class="col s12 left-align">
                        <div class="row" style="margin-left: 10px;">
                            <div class="col s4 m4" style="font-size: 80px; font-weight: 500">
                                <span style="font-size: 80px">DNI</span><br>
                            ...
                            <div class="col s4 m4 center-align" style="font-size: 80px; font-weight: 500">
                                <span style="font-size: 80px">Oficina</span><br>
                ...
                <div class="card-footer center-align" style="background-color:#1860ab">
                    <span class="white-text" style="font-size: 30px;">UGEL HUANUCO</span>
                </div>
            </div>
        </div>
    </div>
