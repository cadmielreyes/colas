                        ...
                        <form method="POST" action=" " enctype="multipart/form-data" aria-label="Configuración de mi cuenta">
                            ...
                            <div class="row">
                                <div class="input-field col m8 offset-m1">
                                    <i class="icon-account_circle prefix"></i>
                                    <label for="cargo" class="col-form-label">Oficina</label>
                                </div>
                                <div class="input-field col m8 offset-m1">
                                    <select class="browser-default custom-select" id="ticket">
                                        <option value="1" selected>Seleccione una opcion</option>
                                        @foreach($tickets as $ticket)
                                        <option value="{{ $ticket->id }}">{{ $ticket->name_ticket }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
