            ...
            <div class="col s12">
                ...
                <div class="card">
                    <ul id="tabs-swipe-demo" class="tabs">
                        ...
                        <li class="tab col s12 m3"><a href="#taquilla" style="color:#0288d1">Oficinas</a></li>
                        ...
                        <table class="centered striped" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->name }} </td>
                                    <td>{{ $user->email }}</td>
                                    @if ($user->tickets->name_ticket != 'VACIO')
                                    <td>{{$user->tickets->name_ticket }}</td>
                                    @else
                                    <td></td>
                                    @endif
                                    <td>
                    ...
                    <div class="card-content row" id="taquilla">
                        <div class="col s12">
                            @if(empty($tickets))
                            <h4 class="center-align">No hay Oficinas registradas.</h4>
                            @else
                            <h4>
